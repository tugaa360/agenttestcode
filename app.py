...
PROMPT_TASK_DECOMPOSITION_USER_REQUEST_PREFIX = "User request: "
PROMPT_TASK_DECOMPOSITION_IMAGE_ANALYSIS_PREFIX = "The user has uploaded an image. Initial analysis: "
PROMPT_TASK_DECOMPOSITION_VIDEO_ANALYSIS_PREFIX = "The user has uploaded a video. Initial analysis: "
...
PROMPT_SYNTHESIZE_RESULTS_INITIAL_IMAGE_SUMMARY = "  - Initial Image Summary: {summary}"
...
PROMPT_SYNTHESIZE_RESULTS_INITIAL_VIDEO_SUMMARY = "  - Initial Video Summary: {summary}"
